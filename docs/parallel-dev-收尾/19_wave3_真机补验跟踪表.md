...
| D-15 | 04 R5b | 端云事件语义 | 🔧 **已拍板待修（08-29 用户定 title_source='device'**，与 generated_by 对齐、避开 B3-5 背书保护 aggregate.py:184 误触）：移入 4b R1 随批次2处置，执行见 docs/4b修复批次执行计划_20260829.md |
