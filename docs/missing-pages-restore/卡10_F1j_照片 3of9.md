...
## 真值
- `.wt/missing-pages/uvue_gen/record_f1j_canvas.json`（390x844 · 40 节点 · 2026-09-02 导出，帧号 F1j）
- 关键文案抽校：9:41 / 照片 / 照片 · 3/9 / × / 分类 / AI 已预选 · 点标签可纠正 / 日常生活 / 家人与朋友

## 任务
RecordSheet 重写·照片 3/9 态
...
2. 降级逐条追加 `_diff_ledger.md`（标注「卡10 F1j」）。
