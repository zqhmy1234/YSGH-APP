...
> **下一步 = 4b 修复批次**：批次1 D-18/D-19（重打包复验）→ 批次2 D-16/D-07/D-08 → 批次3 S2 校准+D-06；散单 D-05/D-10/D-14/D-21 待并批（决策台账 §1.6）。
...
- **移交**：交付文档 08 line12/21/173 与 02 line119 旧数字订正**待用户授权**（决策台账 §5.6）；本波 harness 文件已按新口径统一。
