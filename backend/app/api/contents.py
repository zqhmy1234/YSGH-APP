...
from app.services.exif import extract_exif_datetime as _extract_exif_datetime
...
# D-03：EXIF 解析助手下沉 app/services/exif.py（分片路径的管线回填共用同一真值源）
...
def create_content(
    ...
    # D-02（2026-08-28 真机 Wave3）：key 只做幂等去重，任务参数必须经 *args 传入——
    # 9f0b2f4 收口时漏传导致 worker TypeError: process_content missing 'content_id'。
